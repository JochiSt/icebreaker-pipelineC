...
void top() {
    ...
    m_axis0_tkeep = uint1_array4_le(output_axis.data.tkeep); // Array to uint
    m_axis0_tlast = output_axis.data.tlast;
    m_axis0_tvalid = output_axis.valid;

    m_axis1_tdata = uint8_array4_le(output_axis.data.tdata); // Array to uint
    m_axis1_tkeep = uint1_array4_le(output_axis.data.tkeep); // Array to uint
    m_axis1_tlast = output_axis.data.tlast;
    m_axis1_tvalid = output_axis.valid;
}
